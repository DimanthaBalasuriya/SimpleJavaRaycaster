...
public class Screen {
    ...
    public Screen(int[][] m, int mapW, int mapH, ArrayList<Texture> tex, int w, int h, double x, double y, double xd, double yd, double xp, double yp, ArrayList<Sprite> spritea) {
        map = m;
        mapWidth = mapW;
        mapHeight = mapH;
        textures = tex;
